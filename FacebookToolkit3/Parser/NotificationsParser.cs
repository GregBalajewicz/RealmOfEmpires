...
namespace Facebook.Parser {
    internal sealed class NotificationsParser
    {
        /// <summary>
        /// default constructor
        /// </summary>
        ...
        internal static Notifications ParseNotifications(XmlNode node)
        {
            ...
            if (node != null)
            {
                ...
                {
                    notifications.FriendRequests.Add(((XmlElement)friendNode).InnerText);
                }
                ...
                {
                    notifications.GroupInvites.Add(((XmlElement)groupNode).InnerText);
                }
                ...
                {
                    notifications.EventInvites.Add(((XmlElement)eventNode).InnerText);
                }
