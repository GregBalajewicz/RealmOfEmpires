...
namespace Facebook
{
    ...
    {  
        ...
        /// </summary>
        public FacebookAPI()
            : this(null) { Method = Facebook.Method.graph; }
        ...
        private JSONObject Call(string relativePath, 
                                ...
                                Dictionary<string, string> args)
        {
            Uri baseURL = new Uri("https://" + (Method == Facebook.Method.graph ? "graph" : "api" )  + ".facebook.com");
                                   ...
                                   Dictionary<string, string> args)
        {
            ...
            {
                throw new FacebookAPIException("Server Error", String.Format("Server Error, e.message:{0}, url.AbsoluteUri: {1}", e.Message, url.AbsoluteUri));
            ...
            try
            {
                ...
                Fbg.DAL.Logger.LogEvent("FBAPI", functionName, url.AbsoluteUri, duration.Ticks);
            }
            catch (Exception)
            {
