...
IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'Items2_iItem_BuildingSpeedup')
	BEGIN
		DROP  Procedure  Items2_iItem_BuildingSpeedup
	END
...
CREATE Procedure [dbo].Items2_iItem_BuildingSpeedup
...
begin try 
	...
	insert into Items_BuildingSpeedup(itemID, MinutesAmount) values (@@IDENTITY, @amountInMinutes)
...
begin catch
	...
	SET @ERROR_MSG = 'Items2_iItem_BuildingSpeedup FAILED! ' +  + CHAR(10)
