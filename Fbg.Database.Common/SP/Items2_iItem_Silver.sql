...
IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'Items2_iItem_Silver')
	BEGIN
		DROP  Procedure  Items2_iItem_Silver
	END
...
CREATE Procedure [dbo].Items2_iItem_Silver
...
begin try 
	...
	insert into Items_Silver (itemID, Silver) values (@@IDENTITY, @amount)
...
begin catch
	...
	SET @ERROR_MSG = 'Items2_iItem_Silver FAILED! ' +  + CHAR(10)
