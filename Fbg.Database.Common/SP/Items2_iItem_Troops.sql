...
IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'Items2_iItem_Troops')
	BEGIN
		DROP  Procedure  Items2_iItem_Troops
	END
...
CREATE Procedure [dbo].Items2_iItem_Troops
...
begin try 
	...
	insert into Items_Troops (itemID, UnitTypeID, Amount) values (@@IDENTITY, @nitTypeID, @amount)
...
begin catch
	...
	SET @ERROR_MSG = 'Items2_iItem_Troops FAILED! ' +  + CHAR(10)
