 IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'uCredits_Subtract3')
	BEGIN
		DROP  Procedure  uCredits_Subtract3
	END

GO

CREATE Procedure dbo.uCredits_Subtract3
...
begin catch
	...
	SET @ERROR_MSG = 'uCredits_Subtract3 FAILED! ' +  + CHAR(10)
