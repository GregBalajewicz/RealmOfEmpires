 IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'qReportList_Short')
	BEGIN
		DROP  Procedure  qReportList_Short
	END

GO

CREATE Procedure qReportList_Short
                  @PlayerID as int
                 ,@ReportTypeID as int
...
BEGIN
	begin try
     ...
     begin catch
	     ...
	     SET @ERROR_MSG = 'qReportList_Short FAILED! ' +  + CHAR(10)
