<%@ Page Language="C#" MasterPageFile="~/master_PopupFullFunct.master" AutoEventWireup="true" CodeFile="ConsolidationInProgress_NoLogin.aspx.cs" 
Inherits="ConsolidationInProgress_NoLogin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph1" runat="Server">
    ...
    <div style="font-size: 1.3em">
        ...
        <br />
            ...
            This realm is currently undergoing consolidation 
            <br /><br />This process usually takes less than 30 minutes. 
            <br /><br />In case of trouble, please monitor our <a href="https://twitter.com/RealmOfEmpires" target="twitter">twitter</a> account for live updates 

            <br /><br />To check if the realm is available, try to login : 
            <asp:LinkButton ID="LinkButton1" CssClass="d2_inputbutton" runat="server" onclick="LinkButton1_Click">Try to login</asp:LinkButton>
            <asp:Label ID="Label1" runat="server" Text="Still consolidating. Try again in a few minutes" Visible="false" ForeColor="Red"></asp:Label>
        <br />
            

        <br /><a href="LogoutOfRealm.aspx" class="d2_inputbutton">Back to realm selection screen</a>   
    </div>
    </center>
    </div>
    <% }
        ...
        <STYLE>
            ...
            <img id="background" src="https://static.realmofempires.com/images/backgrounds/M_BG_Wall.jpg" class="stretch" alt="" />
            
                <div id="mobilecontent">
                    
                    <DIV class="titlenew">
                        <div class="titleseparator"></div>                        
                            <div class="titletext">Consolidation</div> 
                            <div class="titletext1 realmID">in progress</div>
                    ...
                    <div class="bottom">
                        ...
                        <div class="sleepText2" >
Realm is currently being consolidated
                          <br />This process usually takes less than 30 minutes. 
                           <br />In case of trouble, please monitor @RealmOfEmpires twitter account for live updates 

                            <br />To check if the realm is available, try to login : 
                            </div>
                        <div class="sleepText3">
                        </div><BR>
                        <asp:LinkButton ID="LinkButton2" runat="server" onclick="LinkButton1_Click">
                            <div class="customButtomBG sfx2">Login</div>
                            </asp:LinkButton>
                        <asp:Label ID="Label2" runat="server" Text="Still consolidating. Try again in a few minutes" Visible="false" ForeColor="Red"></asp:Label>
                    </div>
