<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ManageWhiteListClans.aspx.cs"
    Inherits="ManageWhiteListClans" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:GridView ID="gvwForums" runat="server" AutoGenerateColumns="False" DataKeyNames="WhiteListClanID"
        CellPadding="1" CellSpacing="1" GridLines="none" ShowHeader="True" CssClass="TypicalTable stripeTable"
        OnRowCommand="gvwForums_RowCommand">
        <Columns>
            <asp:TemplateField HeaderText="Name and Description">
                <HeaderTemplate>
                   <%= RS("clanName")%>  </HeaderTemplate>
                <ItemTemplate>
                    <div class="sectionsubtitle">
                        <asp:Literal runat="server" ID="lblClanName" Text='<%# Eval("Name") %>' />
                    </div>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:LinkButton runat="server" CommandName="Remove" CommandArgument='<%#Eval("WhiteListClanID") %>'
     ...
     <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border: solid 1px black">
                        ...
                        <tr>
                            <td style="padding: 1px;">
                                ...
                                <asp:Button CssClass="inputbutton" Text='Add' ID="lnk_Add"
                                    runat="server" OnClick="lnk_Add_Click" ValidationGroup="vg_Add" />
                                <asp:Label ID="lbl_Error" CssClass="Error" runat="server" 
                                    Visible="False" />
                                &nbsp;
                            </td>
                            <td>
