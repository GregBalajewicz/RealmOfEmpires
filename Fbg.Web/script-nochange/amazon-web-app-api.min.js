...
this.Offset.BEGINNING||"string"==typeof a)return!0;console.log("getPurchaseUpdates takes a string offset or Offset.BEGINNING");return!1},getPurchaseUpdates:function(a){var b=this._generateJSRequestId();if(!this._validateGetPurchaseUpdates(a))return this._runCallback("onPurchaseUpdatesResponse",{jsReqId:b,purchaseUpdatesRequestStatus:"INVALID_INPUT"}),b;this._amazonClient.IAP.getPurchaseUpdates(b,a);return b}};
var amznBridge=function(a,b,c){function d(){var a="";JSON&&(a=f+JSON.stringify(e));return a}var e={bridge:a,args:c||[]},f="##AmazonWebAppPlatform/0-";b&&(e.method=b);e.run=function(){var a;window&&(a=window.prompt(d()));return a};return e};function _AmazonJavascriptClient(a,b){this._init(a,b)}
_AmazonJavascriptClient.prototype={_IAP:null,_Cache:null,_Ads:null,_sdkPlatformMode:null,_amazonServices:null,_webAppApiTester:null,_init:function(a,b){this._amazonServices=a;void 0!==b&&(this._webAppApiTester=b)},get webAppApiTester(){null==this._webAppApiTester&&this._determineBindings();return this._webAppApiTester},get sdkPlatformMode(){null==this._sdkPlatformMode&&this._determineBindings();return this._sdkPlatformMode},get IAP(){null==this._IAP&&this._determineBindings();return this._IAP},get Cache(){null==
this._Cache&&this._determineBindings();return this._Cache},get Ads(){null==this._Ads&&this._determineBindings();return this._Ads},_checkPlatformEnabled:function(){var a="";return"undefined"!==typeof window&&(a=window.navigator.userAgent,/AmazonWebAppPlatform\/[\d\.]+;0/.test(a))?!0:!1},_determineBindings:function(){if(this._checkPlatformEnabled()){var a;a={};amznBridge("IAP").run()?(a.registerObserver=function(){amznBridge("IAP","registerObserver").run()},a.ackObserver=function(){amznBridge("IAP",
"ackObserver").run()},a.getUserId=function(a){amznBridge("IAP","getUserId",[a]).run()},a.purchaseItem=function(a,c){amznBridge("IAP","purchaseItem",[a,c]).run()},a.getItemData=function(a,c){amznBridge("IAP","getItemData",[a,c]).run()},a.getPurchaseUpdates=function(a,c){amznBridge("IAP","getPurchaseUpdates",[a,c]).run()}):a=null;this._IAP=a;a={};amznBridge("Cache").run()?(a.clearAppCache=function(){amznBridge("Cache","clearAppCache").run()},a.clearFormData=function(){amznBridge("Cache","clearFormData").run()},
a.clearHistory=function(){amznBridge("Cache","clearHistory").run()},a.clearAllCookies=function(){amznBridge("Cache","clearAllCookies").run()},a.clearExpiredCookies=function(){amznBridge("Cache","clearExpiredCookies").run()},a.clearSessionCookies=function(){amznBridge("Cache","clearSessionCookies").run()}):a=null;this._Cache=a;a={};amznBridge("Ads").run()?(a.positionAd=function(a){amznBridge("Ads","positionAd",[a]).run()},a.loadAd=function(a){amznBridge("Ads","loadAd",[a]).run()},a.collapseAd=function(){amznBridge("Ads",
"collapseAd").run()}):a=null;this._Ads=a}else"undefined"!=typeof AmazonWebAppIAP&&(this._IAP=AmazonWebAppIAP),"undefined"!=typeof AmazonWebAppCache&&(this._Cache=AmazonWebAppCache);"undefined"!=typeof AmazonWebAppGameCircle&&this._addGameCircleBindings();null!=this._IAP||null!=this._GameCircle||null!=this._Cache?this._sdkPlatformMode=this._amazonServices.SdkPlatformMode.ANDROID:(this._sdkPlatformMode=this._amazonServices.SdkPlatformMode.JAVASCRIPT,this._webAppApiTester&&(this._webAppApiTester.initialize(this._amazonServices),
this._IAP=this._webAppApiTester.IAP,this._GameCircle=this._webAppApiTester.GameCircle,this._Cache=this._webAppApiTester.Cache))},_addGameCircleBindings:function(){}};function _AmazonServices(){this._init()}
