...
function UpdateHoverInfo(village) {
    ...
    if (villages['v' + village]) {
        ...
        $('#hoverInfo').empty();
        if (villageInfo.mine && $('#chShowTags').is(":checked")) {
        ...
        $('#hoverMenu').append('<div class="hr"><hr /></div>');
        $('#hoverMenu').append(ROE.getVOVAnchor(vovLink, helpArea));
        $('#hoverMenu').append(ROE.getAttackAnchor(villageInfo.id, villageInfo.X, villageInfo.Y, false, helpArea));
        $('#hoverMenu').append(ROE.getAttackAnchor_OneClick(villageInfo.id, villageInfo.X, villageInfo.Y, false, helpArea));
        $('#hoverMenu').append(ROE.getSupportAnchor(villageInfo.id, villageInfo.X, villageInfo.Y, villageInfo.PID, false, helpArea));
        $('#hoverMenu').append(ROE.getSupportAnchor_OneClick(villageInfo.id, villageInfo.X, villageInfo.Y, villageInfo.PID, false, helpArea));
        $('#hoverMenu').append(ROE.getSupportLookupAnchor(villageInfo.id, villageInfo.mine, false, helpArea, villageInfo.PID));
        $('#hoverMenu').append('<div></div>');


        $('#hoverMenu').append(ROE.getSendSilverAnchor(villageInfo.id, villageInfo.mine, villageInfo.X, villageInfo.Y, villageInfo.PID, helpArea, false, 150, 70));
        $('#hoverMenu').append(ROE.getMapItAnchor(villageInfo.X, villageInfo.Y, helpArea));

        if (villageInfo.mine) {
            $('#hoverMenu').append('<a href="#" onclick="mapRenameVillage(' + villageInfo.id + ')" class="renV sfx2"></a>');
            ROE.helper_AddHelpTextToElement($('#hoverMenu a.renV'), helpArea, 'Rename this village');
        } else {
            var empty = $('<div>').addClass('na').addClass('renV_na');
            $('#hoverMenu').append(empty);
        }
        $('#hoverMenu').append(ROE.getHQAnchor(villageInfo.id, villageInfo.mine, false, helpArea));
        $('#hoverMenu').append(ROE.getRecruitAnchor(villageInfo.id, villageInfo.mine, false, helpArea));

        $('#hoverMenu').append(helpArea);
