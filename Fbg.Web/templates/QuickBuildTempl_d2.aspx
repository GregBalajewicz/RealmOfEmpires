<%@ Page Title="" Language="C#" MasterPageFile="~/templates/masterPopupTemplate_m.master" AutoEventWireup="true" CodeFile="QuickBuildTempl_d2.aspx.cs" Inherits="templates_QuickBuildTempl_d2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph1" runat="Server">
    ...
    <section id="quickbuild_popup" class="themeM-page">
            ...
            <section class="themeM-view default transition">
                ...
                <div class="qSummaryArea qUpgradeSummaryArea">                   
                    <div class="buildTimeArea">
                        <div class="speedUpButton BtnDSm2n fontSilverFrSClrg upgrade grayout" onclick="ROE.QuickBuild.showSpeedUpOptions($(this));"><%=RS("SpeedUp")%><span></span></div>
                        <div class="speedUpFreeButton BtnDSm2n fontButton1L effect-smoothpulse" onclick="ROE.QuickBuild.doSpeedUpFree(); return false;">Finish<div class="icon"></div></div>
                ...
                <div class="qSummaryArea qDowngradeSummaryArea" style="display:none;">                   
                    <div class="buildTimeArea">
                        <div class="speedUpButton BtnDSm2n fontSilverFrSClrg downgrade grayout" onclick="ROE.QuickBuild.showSpeedUpOptions($(this));"><%=RS("SpeedUp")%><span></span></div>
     ...
     <%--                       <div class="buildingBtn smallRoundButtonDark" onclick="ROE.QuickBuild.showBuildingPagePopup(%buildingId%,%villageId%);">
                            ...
                            <div class="buildingResources silverResource fontGoldFrLClrg">
                                %nextCost%
                            </div>
                            <div class="buildingResources foodResource fontGoldFrLClrg">
                                %nextFood%
                            </div>
                            <div class="buildingResources timeResource fontGoldFrLClrg">
                                %nextTime%
                            </div>
                            <div class="upgradeLevel">
                                <a class="fontSilverNumbersLrg" href="javascript:ROE.QuickBuild.doUpgradeBuilding('%buildingId%','%nextLevel%','%upCode%');">%nextLevel%</a>
                            </div>
                            <%--<div class="fontSilverNumbersLrg" onclick="ROE.QuickBuild.doUpgradeBuilding('%buildingId%','%nextLevel%','%upCode%');">%nextLevel%</div>--%>
                            ...
                            <a class="requirementsInfo fontSilverFrSClrg" href="#" onclick="javascript:ROE.QuickBuild.expandRow($(this)); return false;"><%=RS("Info")%></a>
