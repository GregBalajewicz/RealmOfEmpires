<%@ Page Title="" Language="C#" MasterPageFile="~/templates/masterPopupTemplate_m.master" AutoEventWireup="true" CodeFile="QuickRecruitTempl.aspx.cs" Inherits="templates_QuickRecruitTempl" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph1" runat="Server">
    ...
    <div class="recruitPanel template" data-buildingId="%pId%" data-buildingName="%pName%">
        ...
        <div class="slideToQueuePage BtnBSm2 fontSilverFrSClrg" data-buildingId="%pId%" 
    ...
    <div class="unitSection template %lockedDueTo%" data-unitId="%uId%" data-uCanRec="%uCanRec%" data-uRecMax="%uRecMax%" data-unitName="%uName%" data-unitIcon="%uIcon%">
        ...
        <div class="unitInfo">
            ...
            <div class="fontSilverNumbersLrg">%uCurrentCount%</div>
        </div>
        <div class="unitRecruitCommands">
            ...
            <div class="recruitCirc" onclick="ROE.QuickRecruit.doRecruit($(this));"><div class="rcLabel fontGoldFrLClrg">50%</div><div class="rcNum fontWhiteNumbers">%uRec50%</div></div>
            <div class="recruitCirc" onclick="ROE.QuickRecruit.doRecruit($(this));"><div class="rcLabel fontGoldFrLClrg"><%=RS("Max")%></div><div class="rcNum fontWhiteNumbers">%uRecMax%</div></div>
    ...
    <div class="unitSectionGov template" data-unitId="%uId%" data-uCanRec="%uCanRec%" data-uRecMax="%uRecMax%">
        ...
        <div class="unitRecruitCommands %enoughChests%">
            <div class="currentGovCost fontGoldFrLClrg"><%=RS("Use")%> <span class="fontGoldNumbersLrg">%costOfNextGov%</span> <%=RS("Chests")%></div>
            <div class="govFoodCost fontGoldFrLClrg %enoughFood%">%uGovFoodCost%</div>
            <div class="recruitCirc" onclick="ROE.QuickRecruit.doRecruitSingleGov($(this));"><div class="rcNum fontWhiteNumbers">1</div></div>
        </div>
        <div class="sectionDivider"></div>  
    </div> 
    ...
    <div class="massChestSection template">
        <div class="unitIcon" style="background-image:url('%uIcon%');"></div>
        <div class="unitRecruitCommands">
            <div class="massChestInfo fontGoldFrLCmed"><%=RS("massChestInfo")%></div>
            <div class="recruitCirc" onclick="ROE.QuickRecruit.massChestPopup();"><div class="rcMassBuy fontGoldFrLCmed"><%=RS("MassBuy")%></div></div>
        </div>
        <div class="sectionDivider"></div>
    </div>
