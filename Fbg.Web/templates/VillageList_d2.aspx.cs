...
public partial class templates_VillageList : TemplatePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Repeater7.DataBind();
        Repeater8.DataSource = reorderedList;
        Repeater8.DataBind();
        Repeater9.DataSource = reorderedList;
        Repeater9.DataBind();
        ...
        Repeater1.DataBind();
        Repeater10.DataSource = bts;
        Repeater10.DataBind();
    }

    public templates_VillageList()
    {
