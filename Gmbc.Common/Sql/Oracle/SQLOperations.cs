...
namespace Gmbc.Common.Sql.Oracle
{
	//*********************************************************************
	//
	// The SqlOperations class is intended to encapsulate high performance, scalable best practices for 
	...
	public class SQLOperations
	{
		...
		// instances from being created with "new SqlOperations()".
		//
		//*********************************************************************
		...
		private static void AssignParameterValues(OracleParameter[] commandParameters, object[] parameterValues)
		{
			...
			// iterate through the OracleParameters, assigning the values from the corresponding position in the value array
		...
		public static int ExecuteNonQuery(string connectionString, CommandType commandType, string commandText, params OracleParameter[] commandParameters)
		{
			...
			using (OracleConnection cn = new OracleConnection(connectionString))
			{
				...
				int retval = ExecuteNonQuery(cn, commandType, commandText, commandParameters);
				if(cn != null)
					CloseConnection(cn);
				return retval;
			}
		...
		public static int ExecuteNonQuery(string connectionString, string spName, params object[] parameterValues)
		{
			...
			{
				retVal = ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName);
			}
			return retVal;
		}
		...
		//*********************************************************************
		//
		// Execute a OracleCommand (that returns a resultset) against the specified SqlConnection 
		// using the provided parameters.
		// 
		// e.g.:  
		...
		//*********************************************************************
		//
		// Execute a OracleCommand (that returns a 1x1 resultset) against the specified SqlConnection 
		// using the provided parameters.
		// 
		// e.g.:  
